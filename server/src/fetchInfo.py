...
from discord import Guild, Client, VoiceChannel, TextChannel, CategoryChannel
import json
...
async def fetch_change_room_log(member, before, after):
    ...
    for member_one in all_member:
        member_in_room.append(str(member_one.name) + "#" +
                              str(member_one.discriminator))
    ...
    for guild in discord_client.guilds.copy():
        ...
        for channel in guild.channels.copy():
            ...
            try:
                ...
                if str(channel.type) == "voice" and voice is True:

                    if ignore_null_member is not False:
                ...
                elif str(channel.type) == "text" and text is True:
